...
class _DarkotaViewAllState extends State<DarkotaViewAll> {
  ...
  static Future<void> getPostsData(AuthProvider authProvider, DakotaProvider dakotaProvider, String category, BantuanUsaha bantuanUsaha) async {
  ...
  Future<void> initDakota(String category)async{
    AuthProvider aauthProvider = Provider.of<AuthProvider>(context, listen: false);
    DakotaProvider ddakotaProvider = Provider.of<DakotaProvider>(context, listen: false);
    BantuanUsaha bbantuanUsaha = Provider.of<BantuanUsaha>(context, listen: false);
...
//                            physics: NeverScrollableScrollPhysics(),
                              ...
                              itemBuilder: (context, index) {
                                final dakotaData = dakotaProvider.dakotaList[index];
                                return InkWellContainer(authProvider: authProvider, dakotaProvider: dakotaProvider, dakotaData: dakotaData, bantuanUsaha: bantuanUsaha);
                              }),
                        )
                    ),
                  ],
...
class InkWellContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: InkWell(
        onTap: () async {
          await DakotaApi.getPersonalGroup(context, authProvider, dakotaProvider, dakotaData.id, bantuanUsaha);
        },
        child: Container(
            height: 150,
