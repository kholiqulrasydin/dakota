                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          BantuanUsaha bantuanUsaha = Provider.of<BantuanUsaha>(context, listen: false);
                          DakotaProvider dakotaProvider = Provider.of<DakotaProvider>(context, listen: false);
                          await DakotaApi.updateDakota(context,authProvider, bantuanUsaha, dakotaProvider, _namacontroller.text,_namacontroller.text,alamatcontroller.text,_kecamatancontroller.text
                            ...
                            if ( value == 200) {
                              setState(() {
                               ...
                               showFunction = DialogBox(
                                      title: 'Sukses',
                                      description: 'Selamat! data kelompok berhasil diperbarui, silahkan tekan tombol konfirmasi untuk menuju halaman profil kelompok',
                                      buttonText: 'konfirmasi',
                                      image: 'assets/success.gif',
                                      onPressed: () => DakotaApi.getPersonalGroup(context, dakotaProvider, int.parse(widget.id), bantuanUsaha)
                                    );
                                  } else if (value == 500) {
                              setState(() {
                                notLoading = true;
